...
#define LID_SERVO_PIN 16
#define SORTER_SERVO_PIN 4
#define ULT_PROXIMITY_SENSOR_TRIG_PIN 14
#define ULT_PROXIMITY_SENSOR_ECHO_PIN 15
#define ULT_FILL_MONITOR_TRIG_PIN 13
#define ULT_FILL_MONITOR_ECHO_PIN 12
